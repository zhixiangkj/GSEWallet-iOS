...
Commands:
  ...
  start                           Launch iOS Simulator without an deviceReady
  install <application path>      Install the application at the specified path on the iOS Simulator without launching the deviceReady

Options:
  --version                       Print the version of ios-sim
  --help                          Show this help text
  --exit                          Exit after startup
  --log <log file path>           The path where log of the deviceReady running in the Simulator will be redirected to
